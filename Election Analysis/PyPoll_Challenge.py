...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        county_results = (f"{county_name}: {c_votes_percentage}% ({c_votes:,})\n")
    ...
    # 7: Print the county with the largest turnout to the terminal.
        if (c_votes > largest_turnout) and (c_votes_percentage > county_percentage):
            largest_turnout = c_votes
            county_largest_turnout = county_name

    largest_turnout_summary = (
        f"-------------------------\n"
        f"Largest Country Turnout: {county_largest_turnout}\n" 
        f"-------------------------\n"
    )4
